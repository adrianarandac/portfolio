...
import seven2 from "../public/vercel.svg";
    ...
    <>
      ...
      <div className="h-screen pt-[16vh] flex-column projects">
        <div className="grid justify-items-center">
          <div className="w-4/5 tile flex items-center mb-36 bg-grey-800">
            ...
            <div className="flex-col w-4/6">
              ...
              <p className="text-white text-justify pb-4">
                <br />
                SEVEN is a full-stack app to realistically plan your free time in the next 7 days!<br /> <br /> This app revolves around geolocation thanks to Mapbox, which
                also works together with Geocoder library and Google Cloud to transform coordinates to formatted and usable addresses!
              </p>
          ...
          <div className="w-3/5 tile">
            ...
            <p className="text-white text-justify mb-4">
              <br />
              Apipie is a social network for baking lovers and a fun place to share your best recipes and make new friends. Even though it's not as technically
              advanced as SEVEN., this project is my personal favourite because it was really fun to build and also my first experience building a full stack
              app. The app feels responsive, looks clean and <strong>works well</strong>!
            </p>
